...
import '../sass/pages/aPropos.scss';
...
const Apropos = () => {
  ...
  return (
    <div className="apropos">
      <Header />
      <div className="banner" style={{ backgroundImage: `url(${require('../assets/kalen-emsley.png')})`}}>
        <div className='banner_overlay'></div>
      </div>
      <main className='mainContainer'>
        <div className="aboutList-container">
          {aboutListData.map((item, index) => (
            <AboutList key={index} title={item.title} content={item.content} />
          ))}
        </div>
      </main>
      <Footer />
